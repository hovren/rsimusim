...
class Dataset(object):
    def __init__(self):
        ...
        self.landmark_interval_bounds = None
        self.camera_times = []
    ...
    def landmarks_from_nvm(self, nvm_model, frame_to_time_func=None, camera_fps=None):
        ...
        self.landmark_interval_bounds = create_bounds(frame_times)
    ...
    def visualize(self):
        ...
        mlab.points3d(camera_positions[0], camera_positions[1], camera_positions[2], scale_factor=0.5, color=(1,0,0))
...
def create_bounds(times):
    bounds = [times[0] - 0.5*(times[1] - times[0])]
